...
const AIFFLogo = () => {
  return (
    <div className="flex items-stretch gap-1 font-poppins uppercase tracking-wider text-black dark:text-white">
      
      {/* Left Side: AI / FF */}
      <div className="text-right leading-none flex flex-col justify-between">
        <span className="text-gray-700 text-[1.25rem] sm:text-[1.4rem] md:text-[1.6rem] font-semibold">AI</span>
        <span className="text-gray-700 text-[1.25rem] sm:text-[1.4rem] md:text-[1.6rem] font-semibold">FF</span>
      </div>

      {/* Divider Line */}
      <div className="w-px mx-2 bg-black dark:bg-black opacity-40" />
